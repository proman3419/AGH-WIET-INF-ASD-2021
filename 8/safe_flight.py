...
# 2. wybieramy h = min_p jako obecny pulap i wywolujemy dla niego BFS/DFS, w ktorych
# uwzgledniamy warunek na pulap tj. abs(h - pi) <= t
# 3. jezeli BFS/DFS zakonczy sie bez odwiedzenia y to h += 1, jezeli h > max_p to
